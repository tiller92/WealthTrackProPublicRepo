...
export default function GetStarted({user}){
  ...
  <div className="relative flex justify-center h-full w-auto  " >
    <div className="border bg-fourth-green shadow-slate-900 shadow-lg m-5 p-2 w-8/12 h-full rounded-lg ">
